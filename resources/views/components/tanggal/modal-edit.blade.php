<div id="modalEdit" class="hidden">
    <div class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center flex">
        <div class="bg-white rounded-lg shadow-lg w-96 p-6">
            <h2 class="text-lg font-bold mb-4">Edit Jam Per Tanggal</h2>
            <form id="formEdit" onsubmit="update(); return false;">
                ...
                <div class="mb-4">
                    <label for="editJam" class="block mb-1">Jam</label>
                    <input type="time" id="editJam" name="jam" class="border p-2 w-full rounded" required>
                </div>
