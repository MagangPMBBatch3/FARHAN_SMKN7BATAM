<x-layouts.main title="Data Aktivitas">
    <div class="bg-white p-4 rounded shadow w-full">
        ...
        <div class="flex justify-between mb-4">
            <input type="text" id="searchAktivitas" placeholder="Cari ID atau Nama Aktivitas..." 
                   class="border p-2 rounded w-64" oninput="searchAktivitas()">
            <button onclick="openAddAktivitasModal()" class="bg-blue-500 text-white px-4 py-2 rounded">Tambah Data</button>
        </div>
            ...
            <table class="w-full border text-sm">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="p-2 border">Nomor WBS</th>
