    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center flex ">
        <div class="bg-white rounded-lg shadow-lg w-96 p-6">
            ...
            <form id="formEdit" onsubmit="update(); return false;">
                ...
                <div class="mb-4">
                    <label for="editNama" class="block mb-1">Nama User</label>
                    <input type="text" id="editNama" name="nama" class="border p-2 w-full rounded" required>
                </div>
                <div class="mb-4">
                    <label for="editEmail" class="block mb-1">Email User</label>
                    <input type="text" id="editEmail" name="email" class="border p-2 w-full rounded" required>
                </div>
