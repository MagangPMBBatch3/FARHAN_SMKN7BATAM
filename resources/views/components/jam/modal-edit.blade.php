                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="editKodeProyek" name="kode_proyek" class="border p-2 w-full rounded bg-gray-100 text-gray-600" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="editNoWbs" name="no_wbs" class="border p-2 w-full rounded bg-gray-100 text-gray-600" readonly>
                        </div>
                    </div>

                    <div>
                        <label for="editJumlahJam" class="block mb-1">Jumlah Jam</label>
                        <input type="time" id="editJumlahJam" name="jumlah_jam" class="border p-2 w-full rounded" required>
                    </div>
